...
int main()
{
    ...
    static Crypto_JobPrimitiveInfoType localPrimitiveInfo;

    localPrimitiveInfo.primitiveInfo.service = CRYPTO_MACVERIFY;
    // ... other assignments
    
    macVerifyJob.jobPrimitiveInfo = &localPrimitiveInfo;
