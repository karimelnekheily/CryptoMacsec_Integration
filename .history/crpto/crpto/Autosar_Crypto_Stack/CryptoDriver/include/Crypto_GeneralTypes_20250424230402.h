...
#define CRYPTO_NUM_PRIMITIVE_REFS 1
...
typedef struct{
    CryptoPrimitiveAlgorithmFamilyType CryptoPrimitiveAlgorithmFamily[CRYPTO_NUM_PRIMITIVE_ALGORITHM_FAMILY];
    CryptoPrimitiveAlgorithmModeType CryptoPrimitiveAlgorithmMode[CRYPTO_NUM_PRIMITIVE_ALGORITHM_MODE];
    CryptoPrimitiveAlgorithmFamilyType CryptoPrimitiveAlgorithmSecondaryFamily[CRYPTO_NUM_PRIMITIVE_ALGORITHM_SECONDARY_FAMILY]; // Determines the algorithm family used for the crypto service
    CryptoPrimitiveServiceType CryptoPrimitiveService;
